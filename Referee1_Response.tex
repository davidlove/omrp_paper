...
Therefore, $\mathbb{E}A_j^2$ for all the center batches $j=\lceil \bar{\gamma}^{-1} \rceil, \ldots,n_b - \lceil \bar{\gamma}^{-1} \rceil$ are the same. 
...
(Please note that we added brackets to expectations to improve readability as suggested by the other referee.)
\medskip 
