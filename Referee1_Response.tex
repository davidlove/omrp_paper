...
All the new graphs added to the paper in Section 5.4 (Computational Efficiency) are also larger compared to those in the previous version of the paper. 
\medskip 
...
\noindent 
Thank you for this suggestion. 
xxx We expanded this paragraph based on our findings. 
xxx Please note that this paragraph now appears in a new section (\S 5.4 Computational Efficiency). 
