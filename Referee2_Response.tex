...
\noindent 
We shortened and streamlined the OBM review, introducing the main results used in the paper, by combining the previous two sections---\S 2.1 (Overlapping Batch Means) and \S 3.1 (Variably Overlapping Batches)---along with other explanations on OBM that appeared later in the paper. 
