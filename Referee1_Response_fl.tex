...
We specifically added this as a motivation in the first full paragraph on page four of the revised paper. 
\medskip
...
\noindent 
We revised this paragraph in order to improve exposition. 
We used `smaller number of batches' based on the comments of the other referee in the new sentence. 
\medskip 

\noi 
{\it Note:} The revised sentence now appears in the second paragraph of \S 3 (Overlapping Multiple Replications Procedure) as a result of restructuring the introduction based on the comments of the associate editor and the other referee. 
\medskip 
...
We also removed the second equality to save some space because this equality's result was also equally expressed in the last inequality. 
\medskip 
