...
The results on overlapping batch means, discussed in Section \ref{ssec:overlap}, occur in the limit as $n, m, k=n/m \rightarrow \infty$.  
...
We note, however, that this choice of $\gbb_l$ may not be guaranteed to be nonnegative.
