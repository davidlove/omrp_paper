...
The average computation time per batch was found empirically to be well approximated by power law with $p = 0.71$.
...
\begin{figure}[htb!]
	...
	\caption{
		A theoretical comparison of the computational work required to get equivalent variance reduction between OMRP and MRP when the number of batches are increased.
		}
