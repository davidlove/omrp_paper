...
\end{equation}
The corresponding overlapping batch means are no longer independent; however, by simply reusing the data in this fashion---and seemingly in a contradictory way that induces dependence---one obtains a better variance estimator. 
...
The variance estimator given in (\ref{eq:overlap_variance_def}) is changed to
...
Theorem \ref{thm:varvar_conv} gives conditions under which the same asymptotic variance reduction results are achieved for the OMRP optimality gap variance estimator. 
