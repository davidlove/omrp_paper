...
Results for some values of $p$ are shown in Figure \ref{fig:efficiency_theory}.
...
Insertion sort is an efficient sorting algorithm when the values are already largely sorted. 
