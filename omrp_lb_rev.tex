...
%, and present theoretical and computational results. 
...
We show that the resulting point estimators are strongly consistent and the interval estimators are asymptotically valid. 
...
We explore the trade-off between computation time and lower variances.
...
We establish convergence of OMRP estimators to their nonoptimized counterparts (see \S \ref{subsec:conv}--\ref{ssec:validity}); 
thereby establishing the benefits of overlapping in this context. 
