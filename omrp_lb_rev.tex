...
The variance of OMRP variance estimators for DB1 can be less than the asymptotic amount established in Theorem \ref{thm:varvar_conv}. %for the small sample sizes used in these experiments. 
...
Maximizing efficiency and then minimizing total computation time suggests selecting the lowest degree of overlap across all the degrees with the highest efficiency for a given problem and solution method (with warm starting) combination. 
...
Overall, the results in this paper suggest that OMRP could be an efficient method to estimate optimality gaps for a class of stochastic programs when warm starting is available and/or when generating the observations is costly.
