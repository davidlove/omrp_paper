...
Overlapping Batch Means (OBM) method is widely used in simulation to obtain variance estimators with lower variances. 
...
This is referred to as the Multiple Replications Procedure (MRP).   
